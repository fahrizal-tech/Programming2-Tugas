...
public class ReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // Header Section
            Paragraph title = new Paragraph("VELODRIVE CAR RENTAL", fontTitle);
            title.setAlignment(Element.ALIGN_CENTER);
            title.setSpacingAfter(4);
            document.add(title);

            Paragraph address = new Paragraph("Jl. Sukajadi No. 12, Bandung | Phone: +62 812-3456-789 | Email: info@velodrive.com", fontSubtitle);
